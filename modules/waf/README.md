...
| <a name="input_rule_group_reference_rules"></a> [rule\_group\_reference\_rules](#input\_rule\_group\_reference\_rules) | n/a | <pre>list(object({<br/>    name       = string<br/>    priority   = number<br/>    action     = string # "count" or "block"<br/>    statement  = any<br/>    rule_label = optional(list(string), null)<br/>  }))</pre> | `[]` | no |
